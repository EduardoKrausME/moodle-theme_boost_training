...
$templatedata = array_merge($templatedata, \theme_boost_training\template\frontapage_data::slideshow());
$templatedata = array_merge($templatedata, \theme_boost_training\template\frontapage_data::about());
$templatedata = array_merge($templatedata, \theme_boost_training\template\frontapage_data::home_html());

if (get_config("theme_boost_training", "home_type") == 1) {
    // Caso seja HTML, não precisa gerar os blocos.
    $CFG->frontpage = "";
    $CFG->frontpageloggedin = "";
}

echo $OUTPUT->render_from_template('theme_boost_training/frontpage', $templatedata);
