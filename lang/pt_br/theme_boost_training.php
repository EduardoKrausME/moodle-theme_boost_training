...
/**
 * Strings for component 'theme_boost_training', language 'pt_br'
 *
...
$string['choosereadme'] = 'O Boost Training é um tema cuidadosamente elaborado para adicionar cores vibrantes e uma atmosfera alegre ao Moodle.';

// Slides.
$string['settings_slideshow_heading'] = 'SlideShow';
$string['theme_boost_training_slideshow_editbooton'] = 'Editar SlideShow';
...
$string['theme_boost_training_about_editbooton'] = 'Editar bloco Sobre';
...
$string['theme_boost_training_frontpage_home'] = 'Blocos da Home';
...
$string['theme_boost_training_frontpage_bloco'] = 'Bloco "{$a}"';
...
// Privacy.
$string['privacy:metadata'] = 'O tema Boost Training não armazena nenhum dado pessoal sobre nenhum usuário.';
