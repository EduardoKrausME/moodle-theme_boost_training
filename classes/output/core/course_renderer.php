...
class course_renderer extends \core_course_renderer {
    ...
    public function frontpage_available_courses() {
        ...
        $datacursos = [
            ...
            "text" => theme_boost_training_get_setting("frontpage_avaliablecourses_text"),
            "courses" => [],
        ...
        foreach ($courses as $course) {
            ...
            if (file_exists("{$CFG->dirroot}/local/kopere_pay/lib.php")) {
                ...
                if ($koperepaydetalhe && $koperepaydetalhe->course) {
                    ...
                    if ($preco <= 5) {
                        $freename = "<a href='{$viewurl}'>" . get_string("free_name", "theme_boost_training") . "</a>";
                    } else {
            ...
            $datacursos["courses"][] = [
                ...
                "showinstructor" => theme_boost_training_get_setting("frontpage_avaliablecourses_instructor")
                ...
                "acessar" => get_string("acessar", "theme_boost_training"),
                "matricular" =>
                    $priceval ? get_string("matricular", "theme_boost_training") : get_string("acessar", "theme_boost_training"),
                "freename" => $freename,
                "priceval" => $priceval,
            ];
        }

        return $this->output->render_from_template('theme_boost_training/frontpage-courselist', $datacursos);
    }
    ...
    public function frontpage_my_courses() {
        ...
        $datacursos = [
            ...
            "text" => theme_boost_training_get_setting("frontpage_mycourses_text"),
            "courses" => [],
            "has_course_create" => $hascoursecreate,
        ];
        ...
        foreach ($courses as $course) {
            ...
            $datacursos["courses"][] = [
                ...
                "fullname" => $course->get_formatted_name(),
                "countlessons" => course_renderer_util::count_lessson($course),
                "showinstructor" => theme_boost_training_get_setting("frontpage_mycourses_instructor") &&
                    count(course_renderer_util::get_teachers($course)),
                "instructor" => course_renderer_util::get_teachers($course),
                "is_enrolled" => true,
                "acessar" => get_string("continuar", "theme_boost_training"),
            ];
        }
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = '') {
        ...
        return $this->output->render_from_template('theme_boost_training/frontpage-course', $datacurso);
    }
    ...
    public function course_search_form($value = '') {
        ...
        return $this->render_from_template('theme_boost_training/frontpage-search', $data);
    }
