define(["jquery"], function($) {
    var theme_boost_training = {
        ...
        theme_color         : function() {
            var boost_training_theme_color = $("#id_s_theme_boost_training_theme_color");

            $(".seletor-de-theme-boost_training").click(function() {
                var themename = $(this).attr("data-name");
                theme_boost_training._theme_color_select(themename);

                boost_training_theme_color.val(themename);
            });
            boost_training_theme_color.change(function() {
                var themename = boost_training_theme_color.val();
                theme_boost_training._theme_color_select(themename);
        ...
        _theme_color_select : function(themename) {
            ...
            $("#id_s_theme_boost_training_theme_color__color_primary").val(color_primary);
            $("#id_s_theme_boost_training_theme_color__color_secondary").val(color_secondary);
            $("#id_s_theme_boost_training_theme_color__color_buttons").val(color_buttons);
            $("#id_s_theme_boost_training_theme_color__color_names").val(color_names);
            $("#id_s_theme_boost_training_theme_color__color_titles").val(color_titles);
        },

        login : function() {
            var login_theme = $("#id_s_theme_boost_training_login_theme");

            login_theme.change(function() {
                theme_boost_training._login_changue(login_theme.val());
            });
        ...
        about : function() {
            var about_enable = $("#id_s_theme_boost_training_frontpage_about_enable");

            about_enable.change(theme_boost_training._about_changue);
            about_enable.click(theme_boost_training._about_changue);
            theme_boost_training._about_changue();
        },

        _about_changue : function() {
            var about_enable = $("#id_s_theme_boost_training_frontpage_about_enable");
            if (about_enable.is(":checked")) {
                $("#theme_boost_training_about > fieldset > div").show();
                $("#theme_boost_training_about > fieldset > h3").show();
            } else {
                $("#theme_boost_training_about > fieldset > div").hide();
                $("#theme_boost_training_about > fieldset > h3").hide();
            }
        ...
        icons : function() {
            var settings_icons_num = $("#id_s_theme_boost_training_settings_icons_num");

            settings_icons_num.change(theme_boost_training._icons_changue);
            theme_boost_training._icons_changue();
        },
